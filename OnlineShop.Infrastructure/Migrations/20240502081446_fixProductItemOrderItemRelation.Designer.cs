...
namespace OnlineShop.Infrastructure.Migrations
{
    ...
    [Migration("20240502081446_fixProductItemOrderItemRelation")]
    partial class fixProductItemOrderItemRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Core.Entities.Cart", b =>
                {
                    b.HasOne("OnlineShop.Core.Entities.ApplicationUser", "user")
                        .WithOne("Cart")
                        .HasForeignKey("OnlineShop.Core.Entities.Cart", "userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineShop.Core.Entities.CartItem", b =>
                {
                    b.HasOne("OnlineShop.Core.Entities.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("OnlineShop.Core.Entities.Order", b =>
                {
                    b.HasOne("OnlineShop.Core.Entities.ApplicationUser", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("OnlineShop.Core.Entities.UserImage", b =>
                {
                    b.HasOne("OnlineShop.Core.Entities.ApplicationUser", "User")
                        .WithOne("Image")
                        .HasForeignKey("OnlineShop.Core.Entities.UserImage", "UserId");
